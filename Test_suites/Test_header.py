...
class TestHeader(BaseTest):
    ...
    def test_header(self):
        ...
        navigation_panel = header_block.is_element_located(navigation_panel_locator)
        assert navigation_panel is True, \
            "Navigation bar on header not found"

        url_on_page = ""
        header_block.click(header_block.payment_link)
        header_block.is_element_located(PaymentPage().payment_title)
        ...
        header_block.is_element_located(DeliveryPage.delivery_title)
        ...
        header_block.is_element_located(ReturnAndWarrantyPage.return_and_warranty_title)
        ...
        header_block.is_element_located(header_block.support_contact_block)

        header_block.is_element_located(header_block.support_contact_title)
        header_block.is_element_located(header_block.support_phones)
        header_block.is_element_located(header_block.email_support)
        ...
        header_block.is_element_located(main_logo),
        header_block.is_element_located(main_logo)
        ...
        header_block.is_element_located(header_block.sidebar_catalog)
        ...
        header_block.is_element_located(header_block.auth_sidebar)
        close_auth_sidebar = header_block.close_auth_sidebar
        header_block.is_element_located(close_auth_sidebar)
        header_block.click(close_auth_sidebar)

        header_block.click(header_block.wishlist_button)
        header_block.is_element_located(header_block.order_wishlist)
        close_wishlist_button = header_block.close_wishlist
        header_block.is_element_located(close_wishlist_button)
        header_block.click(close_wishlist_button)

        header_block.click(header_block.basket_button)
        header_block.is_element_located(header_block.basket)
        close_basket = header_block.close_basket
        header_block.is_element_located(close_basket)
